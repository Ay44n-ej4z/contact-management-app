...
const CreateContactPage = () => {
    ...
    return (
        <div className="relative min-h-screen bg-gray-100">
            <h1 className="font-semibold p-10 text-2xl items-center text-slate-700 flex justify-center">Contact Details</h1>
            <button
                className="fixed top-8 right-4 bg-blue-500 text-white px-4 py-2 rounded-md"
                            ...
                            <tr {...headerGroup.getHeaderGroupProps()}>
                                {headerGroup.headers.map((column) => (
                                    <th
                                        ...
                                        className="bg-gray-200 text-gray-700 font-bold uppercase text-sm px-6 py-3 border border-gray-300 hidden lg:table-cell"
                                    >
